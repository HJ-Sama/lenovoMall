								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px">
										<a href="${pageContext.request.contextPath}/findOrderById?id=${order.id}&type=admin">
											<img src="${pageContext.request.contextPath}/admin/images/i_edit.png" border="0" style="CURSOR: hand;height:20px;width:20px;">
										</a>
									</td>
									<td align="center" style="HEIGHT: 22px">
                                        <!--  已支付，弹出提示框由操作人确认 -->
									    <c:if test="${order.paystate!=0 }">
											<a href="${pageContext.request.contextPath}/delOrderById?id=${order.id}&type=admin" onclick="javascript:return o_del()">
												<img src="${pageContext.request.contextPath}/admin/images/i_del.png" width="16" height="16" border="0" style="CURSOR: hand;height:20px;width:20px;">
											</a>
										</c:if> 
										<!--  未支付 ，不能删除-->
										<c:if test="${order.paystate==0 }">
