	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>商
							品 列 表</strong></TD>
				</tr>
				<tr>
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/findProductById?id=${p.id}&type=admin">
											...
											border="0" style="CURSOR: hand;height:20px;width:20px;">
									</a></td>
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										...
										onclick="javascript:return p_del()"> <img
											...
											width="16" height="16" border="0" style="CURSOR: hand;height:20px;width:20px;">
									</a></td>
								</tr>
							</c:forEach>
						</table>
