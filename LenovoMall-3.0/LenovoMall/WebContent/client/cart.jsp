								...
								<table width="100%" border="0" cellspacing="0">
									...
									<tr>
										<td>
											...
											width="16" height="16" border="0" style="CURSOR: hand;height:20px;width:20px;"></a>
														</td>
													</tr>
												</table>
											...
											<div style="text-align:right; margin-top:10px">
												...
												<a href="${pageContext.request.contextPath}/showProductByPage">
													<button class="layui-btn layui-btn-warm">继续购物</button>
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
                                                 <!--结账 -->
												<a href="${pageContext.request.contextPath}/client/order.jsp">
													<button class="layui-btn layui-btn-warm">进行结算</button>
												</a>
											</div>
										</td>
									</tr>
