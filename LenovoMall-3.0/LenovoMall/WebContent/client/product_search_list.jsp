...
<body>
	...
	<%-- <div class = "results">
		...
		<ul >
			<li>
				<em>全部结果  &nbsp;&nbsp;&nbsp;&nbsp;共${bean.totalCount}种商品</em>
			</li>
		</div>
		<div class = "kinds">
		...
		<div class = "fast">
			...
			<ul style="margin-left:80px;">
				...
				<li>
					<label>
						<input type="checkbox" value = "isStock" class ="input">
						<em>有库存</em>
					</label>
				</li>
				<li class = "search_box">
					<input id = "startPrice" placeholder="¥">
					 -
					<input id = "endPrice" placeholder="¥">
		...
		<div class ="display">
			...
			<ul>
				<!-- 商品1 -->
				<c:forEach items="${bean.ps}" var="p" varStatus="vs" begin="4" >
				<li>
					<a class = "image_1" href="${pageContext.request.contextPath}/findProductById?id=${p.id}">
					<img src="${pageContext.request.contextPath}${p.imgurl}"
					width:="250" height="160" border="0"/>
